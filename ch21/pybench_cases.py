...
sys.argv): e.g., run a "python pybench_cases.py" to test just one specific 
version on smts, "pybench_cases.py -a" to test all pythons listed, or a 
"py -3 pybench_cases.py -a -t" to trace command lines too.
"""
